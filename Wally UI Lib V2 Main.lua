...
do
    ...
    function library:CreateWindow(name, options)
     ...
     default = {
        ...
        underlinecolor = Color3.fromRGB(85, 255, 255);
        bgcolor        = Color3.fromRGB(25, 25, 25);
        boxcolor       = Color3.fromRGB(25, 25, 25);
        btncolor       = Color3.fromRGB(25, 25, 25);
        dropcolor      = Color3.fromRGB(25, 25, 25);
        sectncolor     = Color3.fromRGB(35, 35, 36);
        bordercolor    = Color3.fromRGB(0, 38, 255);
        ...
        titletextcolor = Color3.fromRGB(0, 38, 255);

        placeholdercolor = Color3.fromRGB(85, 255, 255);
